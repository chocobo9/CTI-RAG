...
|---|---|---|---|---|
| technique extraction | Micro-F1(technique) | CTI-ATE Enterprise n=47 | **0.8582** (P=0.9402 R=0.7893) | >=0.65 -> PASS |
| actor attribution | plausible / correct acc | CTI-TAA n=50 | **0.76** plausible (0.68 correct; C=34 P=4 I=12) | >=0.5 -> PASS |
| heterogeneous retrieval | set/hit@k per category | self query-set data/eval/query_set_v3.jsonl | see per-category below | — |
| generation grounding | RAGAS faithfulness / answer_relevancy | self query-set /mnt/d/proj/CTI-RAG/.claude/worktrees/optimization/rag_cti/data/eval/query_set_v3.jsonl n=14 scored of 14 requested (hybrid@k10) | 0.9506 / 0.8547 | — |
...
|---|---|---|---|---|
| precise | 5 | 0.5263 | 0.4800 | 0.3636 |
| semantic | 10 | 0.4000 | 0.4179 | 0.4146 |
| relationship_direct | 10 | 0.0800 | 0.2675 | 0.3277 |
