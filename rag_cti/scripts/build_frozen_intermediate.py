"""Build the read-only Stage 1 package from frozen local CTI inputs."""
...
def main() -> int:
    ...
    parser.add_argument("--dataset-id", default="cti_rag_frozen_reverse_enrichment")
    ...
    result = build_frozen_intermediate_package(
